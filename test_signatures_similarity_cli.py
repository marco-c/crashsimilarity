...
parser.add_argument('-t','--top', help = 'Number of top similar and different stack traces(Default 10)' )
args = parser.parse_args()


if __name__ == '__main__':
    #download_data.download_crashes(days=1, product=args.product)
    paths = download_data.get_paths(days=1, product=args.product)
